    ...
    <div className="bg-[#F5F6FA] h-screen flex items-center justify-center px-[35px] md:px-0">
      <div className="w-full lg:w-[748px] h-max lg:h-[652px] bg-white shadow-md rounded-lg flex items-center justify-center flex-col py-16 md:py-0">
        <div className="px-[29px] py-[20px]">
          ...
          <p className="font-gilroy_light font-extralight text-pc_black/70 mt-1 w-[75%] mx-auto text-center">
        ...
        <div className="px-[29px] lg:px-32 w-full mt-3 flex items-center justify-center flex-col">
          <div className="grid grid-cols-4 place-content-center place-items-center gap-7 w-max">
